...
购热销商品</em>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as specification>
                                <dl>
                                    <dt>
                                        <div class="fl title">
									...
									<#list specification.attributeValue as attributeValue>
										<dd><a href="javascript:;" class = "{{isSelected('${specification.attributeName}','${attributeValue}')?'selected':''}}"
											   ng-click="addSpec('${specification.attributeName}','${attributeValue}')">${attributeValue} <span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
                                </dl>
							</#list>
						</div>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeItems as customAttribute>
